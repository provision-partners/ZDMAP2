...
const SUMMARY_PILOTS = [
  { id: "p1", phaseId: "phase5", label: "Pilot 1 — RetailMeNot",                       window: "Oct–Dec 2027", color: "#FF6B35" },
  { id: "p2", phaseId: "phase5", label: "Pilot 2 — Tech Flagships (ZDNet, PCMag, CNET)", window: "Feb–Apr 2028", color: "#FF4081" },
  { id: "p3", phaseId: "phase5", label: "Pilot 3 — Mashable, Spiceworks, Lifehacker",    window: "Jun–Aug 2028", color: "#9B59B6" },
];
...
function SummaryMatrix() {
  ...
  // Group pilots by phase (all in phase5)
  const pilotsByPhase = {};
